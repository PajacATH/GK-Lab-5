...
public class Lab5 extends GLJPanel implements GLEventListener, KeyListener{
	...
	private void draw(GL2 gl2) {
		...
		else if(objectNumber==2) //rysowanie piramidy o podstawie n=9
		{
...
//Boki piramidy
	...
	public void display(GLAutoDrawable drawable) {    
		...
		gl2.glClearColor( 0.0f, 0.5f, 0.0f, 0.67f ); // Background color 
